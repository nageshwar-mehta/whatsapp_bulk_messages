...
class WhatsAppMessenger:
    def __init__(self, master):
        ...
        self.numbers_label = tk.Label(master, text="Phone Numbers (comma separated):")
        self.numbers_label.pack()

        self.numbers_entry = tk.Text(master, height=3, width=50)
    ...
    def send_messages(self):
        ...
        numbers = self.numbers_entry.get("1.0", tk.END).strip().split(',')
    ...
    def start_sending(self, message, numbers):
        ...
        # Constructing the links for sending messages to all numbers at once
